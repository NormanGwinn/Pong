...
class Predictor():
    ...
    def init(self):
        ...
        self.ax.text(-2.75,3.75,'Yi = Yp - 4',fontsize=18,color='b')
        self.ax.text(-2.75,1.75,'Yi = -Yp + 2',fontsize=18,color='b')
        self.ax.text(-2.50,-0.25,'Yi = Yp',fontsize=18,color='b')
        self.ax.text(-2.75,-2.25,'Yi = -Yp - 2',fontsize=18,color='b')
        self.ax.text(-2.75,-4.25,'Yi = Yp + 4',fontsize=18,color='b')
